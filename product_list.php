...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_POST['action']) && $_POST['action'] === 'add') {
        ...
        if ($check_stmt->get_result()->num_rows > 0) {
            $_SESSION['msg_error'] = "ชื่อสินค้า \"$name\" มีอยู่ในระบบแล้ว กรุณาใช้ชื่ออื่น";
    ...
    if (isset($_POST['action']) && $_POST['action'] === 'edit') {
        ...
        $check_stmt->execute();
        if ($check_stmt->get_result()->num_rows > 0) {
            $_SESSION['msg_error'] = "ชื่อสินค้า \"$name\" ถูกใช้ไปแล้ว กรุณาใช้ชื่ออื่น";
            ...
            <div class="table-scroll-container">
                <table>
                    ...
                    <tbody>
                        <?php if ($products->num_rows > 0): ?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-truncate-2" title="<?= htmlspecialchars($row['name']) ?>">
                                            <?= $row['name'] ?>
                                        </div>
                                    </td>

                                    <td>
                                        <div class="text-truncate-1" title="<?= htmlspecialchars($row['category_name']) ?>">
                                            <?= $row['category_name'] ?>
                                        </div>
                                    </td>
                                    <td><?= $row['unit'] ?></td>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="11" style="text-align:center; padding:50px;">ไม่พบข้อมูลสินค้า</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
