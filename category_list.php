...
<head>
    ...
    <style>
        ...
        .btn-edit { background:#f1c40f; padding:7px 12px; color:white; border-radius:8px; border:none; cursor:pointer; font-size:14px;}
        .btn-delete { background:#e74c3c; padding:7px 12px; color:white; border-radius:8px; border:none; cursor:pointer; font-size:14px;}
        ...
        <div style="overflow-x:auto;">
            <table>
                ...
                <?php if ($categories->num_rows > 0): ?>
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr><td colspan="4" style="text-align:center; padding:20px;">ไม่มีข้อมูล</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
